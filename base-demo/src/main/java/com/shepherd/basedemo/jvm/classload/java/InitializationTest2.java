...
public class InitializationTest2 {
    public static int n = 1;   //在初始化阶段赋值
    ...
    public static final String s0 = "hello";   //在链接阶段的准备环节赋值
    public static final String s1 = new String("hello"); //在初始化阶段赋值

    public static String s2 = "hello";  //在初始化阶段赋值
